      ...
      <div className="space-y-8 px-4 py-16">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="flex flex-col items-start">
            ...
            <div className="w- mt-5 flex w-full items-center justify-between text-xs font-medium text-gray-500">
              <span>니꼬</span>
              <span>18시간 전</span>
            </div>
            <div className="mt-3 flex w-full space-x-5 border-b-[1px] border-t py-2.5 text-gray-700">
