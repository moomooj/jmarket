...
const Upload: NextPage = () => {
  return (
    <div className="px-4 py-16">
      ...
      <div className="my-5">
        ...
        <div className="relative flex items-center rounded-md shadow-sm ">
          ...
          <div className="absolute right-0 flex items-center pr-3">
            <span className="pointer-events-none text-gray-500">USD</span>
          </div>
        </div>
      </div>
      <div>
      ...
      <button className="shadow-s mt-4 w-full rounded-md border border-transparent bg-orange-400 px-4 py-2 font-medium text-white hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
        Upload product
      </button>
    </div>
  );
